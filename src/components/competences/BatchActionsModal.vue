        ...
        <div class="p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
          ...
          <div v-if="selectedAction === 'assign'" class="mt-3">
            ...
            >
              ...
              <optgroup v-if="authStore.externalMembers.length > 0" label="Membres externes">
                <option v-for="member in authStore.externalMembers" :key="member.id" :value="'ext:' + member.id">
